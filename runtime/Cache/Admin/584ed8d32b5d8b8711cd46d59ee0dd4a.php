     ...
     <div class="mainlist">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <th width="180"><?php echo ($vo["remark"]); ?></th>
            <th width="80"><?php echo ($vo["status"]); ?></th>
            <th width="300"><a href="__URL__/adminaccess/id/<?php echo ($vo["id"]); ?>">后台栏目权限</a>|<a href="__URL__/frontaccess/id/<?php echo ($vo["id"]); ?>">前台栏目权限</a>|<a href="__URL__/rolecontrol/id/<?php echo ($vo["id"]); ?>">修改</a>|<a href="#"  class="del" data-id="<?php echo ($vo["id"]); ?>">删除</a></th>
